...
@Component({
  selector: 'app-mod-prestsalud',
  templateUrl: './mod-prestsalud.component.html',
  styleUrls: ['./mod-prestsalud.component.css']
})
export class ModPrestsaludComponent implements OnInit {
  ...
  putActividades(){
    ...
    if(this.nomFormControl.valid ) {
      this.httpClient.put('http://159.65.222.132:804/api/PrestadoresDeSalud/'+this.data.id,{id: this.data.id, nombre: this.ActividadesDTO.nombre, activo: op} ).subscribe(data => {
